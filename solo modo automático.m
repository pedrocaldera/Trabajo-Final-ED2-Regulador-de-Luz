...
INICIO		
  ...
  BSF		STATUS, RP0
      ...
      MOVLW 	        0xED
      MOVWF 	        TMR0
      MOVLW 	        b'10000111' 		        ; TMR0 ON, prescaler 1:256
      MOVWF 	        OPTION_REG
  ...
  BSF 		RCSTA,SPEN		; habilita serial
      BSF 		RCSTA,CREN		; RX on
        ...
        ;BSF     	INTCON, INTE            ;está comentado porque ahora en esta versión no lo usamos
        BCF     	INTCON, INTF
...
MAIN
        ...
        ; Invertir para compensar (más luz -> menos duty)
        COMF           adc_val, F          ; 0..255 -> 255..0


        ; Duty 8 bits -> CCPR1L (LSB en 0)
        MOVF           adc_val, W
        MOVWF          CCPR1L
        BCF            CCP1CON, 5
        BCF            CCP1CON, 4
...
ISR         
        ...
        MOVLW           0xED                            ; o 0xEC si elegiste ~5.12 ms
        MOVWF           TMR0
